 ...
 * @param e8
 */
vd1m::Mat3::Mat3(float e0, float e1, float e2, float e3, float e4, float e5, float e6, float e7, float e8) {
    matrix3[0] = e0;
    matrix3[1] = e1;
    matrix3[2] = e2;
 ...
 * @return Matrix3
 */
vd1m::Mat3& vd1m::Mat3::operator=(const vd1m::Mat3 &m2) {
 ...
 * @return Matrix3
 */
vd1m::Mat3& vd1m::Mat3::operator*(const float &k) {
 ...
 * @return Vector3
 */
vd1m::Vec3 vd1m::Mat3::operator*(const vd1m::Vec3 &v) {
    vd1m::Vec3 temp_vec3;
 ...
 */
void vd1m::Mat3::set_as_identity() {
    for(int i = 0; i < 9; i++){
        matrix3[i] = 0.0f;
    }
    matrix3[0] = 1.0f;
 ...
 */
void vd1m::Mat3::set_as_rotation90_x_axis() {
    for(int i = 0; i < 9; i++){
        matrix3[i] = 0.0f;
    }
    matrix3[0] = 1.0f;
 ...
 * @param theta
 */
void vd1m::Mat3::set_as_rotationTheta_x_axis(float theta) {
    for(int i = 0; i < 9; i++){
        matrix3[i] = 0.0f;
    }
    matrix3[0] = 1.0f;
 ...
 */
void vd1m::Mat3::set_as_rotation90_y_axis() {
    for(int i = 0; i < 9; i++){
        matrix3[i] = 0.0f;
    }
 ...
 * @param theta
 */
void vd1m::Mat3::set_as_rotationTheta_y_axis(float theta) {
    for(int i = 0; i < 9; i++){
        matrix3[i] = 0.0f;
    }
 ...
 */
void vd1m::Mat3::set_as_rotation90_z_axis() {
    for(int i = 0; i < 9; i++){
        matrix3[i] = 0.0f;
    }
    matrix3[0] = roundf(cos(90.0f));
 ...
 * @param theta
 */
void vd1m::Mat3::set_as_rotationTheta_z_axis(float theta) {
    for(int i = 0; i < 9; i++){
        matrix3[i] = 0.0f;
    }
    matrix3[0] = roundf(cos(theta));
