 ...
 * @param e3
 */
vd1m::Mat2::Mat2(float e0, float e1, float e2, float e3) {
    matrix2[0] = e0;
    matrix2[1] = e1;
 ...
 * @return Matrix2
 */
vd1m::Mat2& vd1m::Mat2::operator=(const vd1m::Mat2 &m2) {
 ...
 * @return Matrix2
 */
vd1m::Mat2& vd1m::Mat2::operator*(const float &k) {
 ...
 * @return Vector2
 */
vd1m::Vec2 vd1m::Mat2::operator*(const vd1m::Vec2 &v) {
    vd1m::Vec2 temp_vec2;
 ...
 */
void vd1m::Mat2::set_as_identity() {
    for(int i = 0; i < 4; i++){
        matrix2[i] = 0.0f;
    }
    matrix2[0] = 0.0f;
 ...
 */
void vd1m::Mat2::set_as_rotation90_counter_clockwise() {
    for(int i = 0; i < 4; i++){
        matrix2[i] = 0.0f;
    }
 ...
 * @param theta
 */
void vd1m::Mat2::set_as_rotationTheta_counter_clockwise(float theta) {
    for(int i = 0; i < 4; i++){
        matrix2[i] = 0.0f;
    }
 ...
 */
void vd1m::Mat2::set_as_rotation90_clockwise() {
    for(int i = 0; i < 4; i++){
        matrix2[i] = 0.0f;
    }
    matrix2[0] = roundf(cos(90.0f));
 ...
 * @param theta
 */
void vd1m::Mat2::set_as_rotationTheta_clockwise(float theta) {
    for(int i = 0; i < 4; i++){
        matrix2[i] = 0.0f;
    }
    matrix2[0] = roundf(cos(theta));
