 ...
 * @param e15
 */
vd1m::Mat4::Mat4(float e0, float e1, float e2, float e3, float e4, float e5, float e6, float e7, float e8,
 ...
 * @return Matrix4
 */
vd1m::Mat4& vd1m::Mat4::operator=(const vd1m::Mat4 &m2) {
 ...
 * @return Matrix4
 */
vd1m::Mat4& vd1m::Mat4::operator*(const float &k) {
 ...
 * @return Vector4
 */
vd1m::Vec4 vd1m::Mat4::operator*(const vd1m::Vec4 &v) {
    vd1m::Vec4 temp_vec4;
 ...
 */
void vd1m::Mat4::set_as_identity() {
    for(int i = 0; i < 16; i++){
        matrix4[i] = 0.0f;
    }
    matrix4[0] = 1.0f;
 ...
 */
void vd1m::Mat4::set_as_rotation90_x_axis() {
    for(int i = 0; i < 16; i++){
        matrix4[i] = 0.0f;
    }
    matrix4[0] = 1.0f;
 ...
 * @param theta
 */
void vd1m::Mat4::set_as_rotationTheta_x_axis(float theta) {
    for(int i = 0; i < 16; i++){
        matrix4[i] = 0.0f;
    }
    matrix4[0] = 1.0f;
 ...
 */
void vd1m::Mat4::set_as_rotation90_y_axis() {
    for(int i = 0; i < 16; i++){
        matrix4[i] = 0.0f;
    }
 ...
 * @param theta
 */
void vd1m::Mat4::set_as_rotationTheta_y_axis(float theta) {
    for(int i = 0; i < 16; i++){
        matrix4[i] = 0.0f;
    }
 ...
 */
void vd1m::Mat4::set_as_rotation90_z_axis() {
    for(int i = 0; i < 16; i++){
        matrix4[i] = 0.0f;
    }
    matrix4[0] = roundf(cos(90.0f));
 ...
 * @param theta
 */
void vd1m::Mat4::set_as_rotationTheta_z_axis(float theta) {
    for(int i = 0; i < 16; i++){
        matrix4[i] = 0.0f;
    }
    matrix4[0] = roundf(cos(theta));
 ...
 * @return Matrix4
 */
vd1m::Mat4& vd1m::Mat4::inverse() {
    //do stuff
}

void vd1m::Mat4::to_string() {
